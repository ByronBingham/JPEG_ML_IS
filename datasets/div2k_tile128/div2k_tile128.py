...
class Div2kTile128(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        path_train = Path("e:/datasets/div2k_dataset/preprocessed/tile128/train")
        path_validation = Path("e:/datasets/div2k_dataset/preprocessed/tile128/validation")
